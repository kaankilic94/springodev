...
<%-- 	<div>
		<form:form modelAttribute="task" action="task" method="POST">
			...
			id:<form:input type="text"  id="user_id" path="userId"/>
			name:<form:input type="text" id="name" path="name"/>
			date:<form:input type="date" id="end_date" path="tempDate"/>
			description:<form:input type="text" id="description" path="description"/>
